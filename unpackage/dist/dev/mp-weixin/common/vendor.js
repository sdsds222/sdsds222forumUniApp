...
const globalStyle = {
  ...
  navigationBarTitleText: "测试UniApp应用程序",
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      selectedIconPath: "static/images/history.png"
    },
    {
      text: "个人",
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.43.194",\n        "172.18.96.1",\n        "172.23.0.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "C:/Users/13633/Desktop/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"testunispp","spaceId":"mp-b89e3139-9de2-4539-a3ac-81751b9abf98","clientSecret":"qywrjTBdkEotiePC524H1w==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__E9D51D0";
} catch (e2) {
